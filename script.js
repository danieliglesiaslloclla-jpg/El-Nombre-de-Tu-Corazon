...
async function animateHeartTerminal() {
    ...
    // Asegura que el corazón NO esté latiendo mientras se dibuja
    ...
    for (let i = 0; i < heartLines.length; i++) {
        ...
        // Pausa estilo terminal
        await sleep(300);
    }

    // CUANDO TERMINA DE DIBUJARSE → activar latido suave
    setTimeout(() => {
        heartContainer.style.animation = "heartbeatSoft 1.8s infinite ease-in-out";
    }, 150);
}
